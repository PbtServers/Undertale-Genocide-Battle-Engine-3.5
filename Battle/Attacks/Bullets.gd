...
onready var boneStabHSpr: = preload("res://Textures/Battle/Bullets/BoneH.png")
onready var boneStabVSpr: = preload("res://Textures/Battle/Bullets/BoneV.png")

onready var bone: = preload("res://Battle/Attacks/Bullets/Bone/Bone.tscn")
onready var boneStab: = preload("res://Battle/Attacks/Bullets/BoneStab/BoneStab.tscn")
onready var gasterBlaster: = preload("res://Battle/Attacks/Bullets/GasterBlaster/GasterBlaster.tscn")
onready var platform: = preload("res://Battle/Attacks/Bullets/Platform/Platform.tscn")
